...
export default function Pacotes() {
  ...
  return (
    <>
      ...
      {/* Pacotes Principais */}
      <section className="py-24 px-6 md:px-16 bg-gray-100 text-blue-900">
          ...
          <div className="bg-white border-2 border-sky-400 rounded-3xl p-8 shadow-xl flex flex-col justify-between relative overflow-hidden transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
            ...
            <div>
              ...
              <ul className="space-y-3 mb-8 text-gray-700">
                ...
                <li className="flex items-center gap-2">
                  <i className="fas fa-check text-sky-500"></i>Hotel 4 estrelas
                  com café da manhã
                </li>
                <li className="flex items-center gap-2">
                  <i className="fas fa-check text-sky-500"></i>Passeios guiados
                  e transporte incluso
                </li>
                <li className="flex items-center gap-2">
                  <i className="fas fa-check text-sky-500"></i>Datas: 10 a 15 de
                  Abril 2026
                </li>
              </ul>
            </div>
          ...
          <div className="bg-white border border-gray-200 rounded-3xl p-8 shadow-lg flex flex-col justify-between transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:border-blue-300">
            <div>
              ...
              <ul className="space-y-3 mb-8 text-gray-700">
                ...
                <li className="flex items-center gap-2">
                  <i className="fas fa-check text-sky-500"></i>Hotel à beira-mar
                </li>
                <li className="flex items-center gap-2">
                  <i className="fas fa-check text-sky-500"></i>Passeios e
                  atividades aquáticas
                </li>
                <li className="flex items-center gap-2">
                  <i className="fas fa-check text-sky-500"></i>Datas: 01 a 07 de
                  Maio 2026
                </li>
              </ul>
            </div>
          ...
          <div className="bg-white border border-gray-200 rounded-3xl p-8 shadow-lg flex flex-col justify-between transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:border-blue-300">
            <div>
              ...
              <ul className="space-y-3 mb-8 text-gray-700">
                ...
                <li className="flex items-center gap-2">
                  <i className="fas fa-check text-sky-500"></i>Transporte 4x4
                  pelo deserto
                </li>
                <li className="flex items-center gap-2">
                  <i className="fas fa-check text-sky-500"></i>Passeios guiados
                ...
                <li className="flex items-center gap-2">
                  <i className="fas fa-check text-sky-500"></i>Datas: 15 a 20 de
                  Junho 2026
                </li>
              </ul>
            </div>
